package com.example.connecttosoapapiapp.GIModule.Adapter;
...
public class GiEditItemsAdapter
        extends RecyclerView.Adapter<GiEditItemsAdapter.MyViewHolder> {

    private List<GIModule> ItemsList;
    GIModule giModule;
    ...
    public GiEditItemsAdapter(List<GIModule> moviesList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        giModule = ItemsList.get(position);
        if (giModule.getChecked_Item()){
        ...
        holder.txt_material_search.setText(giModule.getMAT_CODE1().subSequence(6,18));
        holder.txt_short_text_search.setText(giModule.getUOM_DESC1());
        holder.txt_ean11_search.setText(giModule.getGTIN1());
        holder.txt_quantity_search.setText(giModule.getAVAILABLE_STOCK1());
        holder.txt_delivered_quantity_search.setText(giModule.getQTY1());
        holder.txt_po_unite_search.setText(giModule.getMEINH1());
    ...
    public List<GIModule> ReturnListOfItems(){

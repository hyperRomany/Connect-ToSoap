package com.example.connecttosoapapiapp.GIModule.Modules;

public class GIModule {

        public static final String TABLE_GIModule_NAME = "GIModule";
        ...
        public static final String CREATE_GIModule_TABLE =
                "CREATE TABLE " + TABLE_GIModule_NAME + "("
                        + GTIN + " VARCHAR(10),"
                        + ISS_SITE + " VARCHAR(10),"
                        + REC_SITE + " VARCHAR(10),"
                        + MAT_CODE + " VARCHAR(35),"
        ...
        public GIModule(String GTIN1, String ISS_SITE1, String REC_SITE1, String MAT_CODE1, String UOM_DESC1,

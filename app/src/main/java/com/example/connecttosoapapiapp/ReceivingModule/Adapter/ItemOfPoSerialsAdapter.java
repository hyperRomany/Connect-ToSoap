...
public class ItemOfPoSerialsAdapter extends RecyclerView.Adapter<ItemOfPoSerialsAdapter.MyViewHolder> {
    ...
    public ItemOfPoSerialsAdapter(List<PO_SERIAL> moviesList) {
